...
public class QuickSort {
	...
	//	int leftIndex = left;
	//	int rightIndex = right; //If we dont put -1 we will get OutOfBoundsException for first iteration as arr is starting 
		//with 0 but length is starting from 1.
	...
	public static void quickSort(int[] arr, int left, int right){ 
		...
		if(pivot>1)quickSort(arr, pivot+1, right);
		}
